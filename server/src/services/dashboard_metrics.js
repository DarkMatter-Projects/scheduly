...
const METRICS = [
  ...
  { key: 'video_views_10s',     label: 'Video views (10s)',   section: 'video',       category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.video_views_10s',       available: false,
    scope: 'content',
    description: '10-second video views. Meta retired this Page-level aggregate — the number is only available per-video via /{video-id}/video_insights.' },
  { key: 'video_views_30s',     label: 'Video views (30s)',   section: 'video',       category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.video_views_30s',       available: false,
    scope: 'content',
    description: '30-second / complete video views. Meta retired this Page-level aggregate — the number is only available per-video via /{video-id}/video_insights.' },
