...
const METRICS = [
  ...
  { key: 'organic_net_followers', label: 'Organic net followers', section: 'followers', category: 'channel', platforms: ['linkedin'],                                  format: 'number',   source: 'derived.organic_net_followers', available: false,
    scope: 'channel',
    description: 'Net new organic follows during the period. Requires LinkedIn organizationalEntityFollowerStatistics ingestion (r_organization_social scope).' },
  { key: 'paid_net_followers',  label: 'Paid net followers',  section: 'followers',   category: 'channel', platforms: ['linkedin'],                                    format: 'number',   source: 'derived.paid_net_followers',     available: false,
    scope: 'channel',
    description: 'Net new follows acquired via paid LinkedIn ad campaigns. Requires Marketing Developer Platform scopes.' },
  { key: 'following',           label: 'Following',           section: 'followers',   category: 'channel', platforms: ['twitter'],                                     format: 'number',   source: 'derived.following',              available: false,
    scope: 'channel',
    description: 'Number of accounts your channel follows. Requires X API user lookup ingestion.' },
  { key: 'net_tweets_retweets', label: 'Net tweets and retweets', section: 'engagements', category: 'channel', platforms: ['twitter'],                                 format: 'number',   source: 'derived.net_tweets_retweets',    available: false,
    scope: 'content',
    description: 'Sum of original tweets and retweets published from your channel during the period. Requires X API tweet timeline ingestion.' },
  { key: 'net_listed',          label: 'Net listed',          section: 'followers',   category: 'channel', platforms: ['twitter'],                                     format: 'number',   source: 'derived.net_listed',             available: false,
    scope: 'channel',
    description: 'Net change in the number of public lists your account appears on. Requires X API user lookup ingestion.' },
  // ── Re-added FB distribution placeholders (used by Distribution overview) ──
  { key: 'organic_impressions', label: 'Organic impressions', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.organic_impressions',   available: false,
    scope: 'channel',
    description: 'Impressions on posts not boosted by ads. Requires page_impressions_organic ingestion (coming soon).' },
  { key: 'viral_impressions',   label: 'Viral impressions',   section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.viral_impressions',     available: false,
    scope: 'channel',
    description: 'Impressions from viral stories. Requires page_impressions_viral ingestion (coming soon).' },
  { key: 'non_viral_impressions', label: 'Non-viral impressions', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                            format: 'number',   source: 'derived.non_viral_impressions', available: false,
    scope: 'channel',
    description: 'Impressions from direct/owned distribution. Requires page_impressions_nonviral ingestion (coming soon).' },
  { key: 'viral_amplification', label: 'Viral amplification', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'percent',  source: 'derived.viral_amplification',   available: false,
    scope: 'channel',
    description: 'Share of impressions resulting from people sharing your posts. Requires viral-share ingestion (coming soon).' },
