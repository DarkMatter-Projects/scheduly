...
const METRICS = [
  ...
  { key: 'followers_increase',  label: 'Followers increase',  section: 'followers',   category: 'channel', platforms: ['facebook_page','instagram_business','youtube'],            format: 'number',   source: 'derived.followers_increase',     available: false,
    scope: 'channel',
    description: 'The number of new follows during the period. Requires page_fans_adds ingestion (coming soon).' },
  { key: 'followers_decrease',  label: 'Followers decrease',  section: 'followers',   category: 'channel', platforms: ['facebook_page','instagram_business','youtube'],            format: 'number',   source: 'derived.followers_decrease',     available: false,
    scope: 'channel',
    description: 'The number of unfollows during the period. Requires page_fans_removes ingestion (coming soon).' },
  { key: 'page_likes',          label: 'Page likes',          section: 'followers',   category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.page_likes',             available: false, deprecated: true,
    scope: 'channel',
    description: 'Total Page likes. Meta deprecated the page_fans metric in Graph v17; use Followers instead.' },
  { key: 'net_new_page_likes',  label: 'Net new page likes',  section: 'followers',   category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.net_new_page_likes',     available: false, deprecated: true,
    scope: 'channel',
    description: 'Net change in Page likes during the period. Deprecated Facebook metric.' },
  { key: 'page_likes_increase', label: 'Page likes increase', section: 'followers',   category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.page_likes_increase',    available: false, deprecated: true,
    scope: 'channel',
    description: 'Number of new Page likes during the period. Deprecated Facebook metric.' },
  { key: 'unpaid_fans_increase', label: 'Unpaid fans increase', section: 'followers', category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.unpaid_fans_increase',   available: false,
    scope: 'channel',
    description: 'Organic new Page fans (not from paid ads). Requires page_fans_by_unlike_source ingestion.' },
  { key: 'paid_fans_increase',  label: 'Paid fans increase',  section: 'followers',   category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.paid_fans_increase',     available: false,
    scope: 'channel',
    description: 'New Page fans acquired via paid ad campaigns. Requires page_fans_by_like_source ingestion.' },
  { key: 'page_likes_decrease', label: 'Page likes decrease', section: 'followers',   category: 'channel', platforms: ['facebook_page'],                                            format: 'number',   source: 'derived.page_likes_decrease',    available: false, deprecated: true,
    scope: 'channel',
    description: 'Number of Page unlikes during the period. Deprecated Facebook metric.' },
  ...
  { key: 'organic_impressions', label: 'Organic impressions', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'post_analytics.impressions',    available: true, deprecated: true,
    scope: 'content',
    description: 'Impressions on posts not boosted by ads. Deprecated Facebook metric — Meta now reports total Views instead.' },
  { key: 'viral_impressions',   label: 'Viral impressions',   section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.viral_impressions',     available: false, deprecated: true,
    scope: 'channel',
    description: 'Impressions from viral stories (shares from friends). Deprecated Facebook metric.' },
  { key: 'non_viral_impressions', label: 'Non-viral impressions', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                            format: 'number',   source: 'derived.non_viral_impressions', available: false, deprecated: true,
    scope: 'channel',
    description: 'Impressions from direct/owned distribution (not from shares). Deprecated Facebook metric.' },
  ...
  { key: 'organic_reach_daily', label: 'Organic reach (daily)', section: 'distribution', category: 'channel', platforms: ['facebook_page','instagram_business'],         format: 'number',   source: 'derived.organic_reach_daily',   available: false,
    scope: 'channel',
    description: 'Daily unique reach from organic posts only (no ads). Requires page_impressions_organic_unique ingestion.' },
  { key: 'viral_amplification', label: 'Viral amplification', section: 'distribution', category: 'channel', platforms: ['facebook_page'],                                format: 'percent',  source: 'derived.viral_amplification',   available: false, deprecated: true,
    scope: 'channel',
    description: 'Share of impressions resulting from people sharing your posts. Deprecated Facebook metric.' },
  ...
  { key: 'video_views',         label: 'Video views',         section: 'video',       category: 'channel', platforms: ['facebook_page','tiktok','youtube'],            format: 'number',   source: 'derived.video_views',           available: false,
    scope: 'content',
    description: 'Total number of times videos in your posts were viewed. Requires page_video_views ingestion (coming soon).' },
  { key: 'paid_video_views_3s', label: 'Paid video views (3s)', section: 'video',     category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.paid_video_views_3s',   available: false,
    scope: 'channel',
    description: '3-second video views from paid placements. Requires ad-insights video ingestion.' },
  ...
  { key: 'video_views_10s',     label: 'Video views (10s)',   section: 'video',       category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.video_views_10s',       available: false, deprecated: true,
    scope: 'content',
    description: '10-second video views. Deprecated Facebook metric.' },
  ...
  { key: 'video_watch_time',    label: 'Watch time',          section: 'video',       category: 'channel', platforms: ['facebook_page','youtube'],                     format: 'number',   source: 'derived.video_watch_time',      available: false,
    scope: 'content',
    description: 'Total seconds of video watch time. Requires page_video_view_time ingestion (coming soon).' },
  ...
  { key: 'repeated_video_views', label: 'Repeated video views', section: 'video',     category: 'channel', platforms: ['facebook_page'],                                format: 'number',   source: 'derived.repeated_video_views',  available: false,
    scope: 'content',
    description: 'Number of viewers who replayed a video. Requires page_video_repeat_views ingestion.' },
  ...
  { key: 'comments',            label: 'Comments',            section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business','linkedin','tiktok','youtube'], format: 'number',   source: 'post_analytics.comments_count', available: true, deprecated: true,
    scope: 'content',
    description: 'The total number of comments left on posts during the period. (Some Facebook breakdowns are deprecated.)' },
  { key: 'shares',              label: 'Shares',              section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business','linkedin','tiktok','youtube'], format: 'number',   source: 'post_analytics.shares',         available: true, deprecated: true,
    scope: 'content',
  ...
  { key: 'engagements',         label: 'Engagements',         section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business','linkedin','tiktok','youtube'], format: 'number', source: 'derived.engagements',         available: true, deprecated: true,
    scope: 'content',
    description: 'Sum of reactions, comments and shares on posts during the period. Deprecated on Facebook — use Interactions.' },
  { key: 'engagement_rate',     label: 'Engagement rate',     section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business','linkedin','tiktok'], format: 'percent',  source: 'derived.engagement_rate',       available: true, deprecated: true,
    scope: 'content',
    description: 'Engagements divided by impressions, averaged across posts. Facebook deprecated this metric — use Interaction rate.' },
  { key: 'engagement_rate_reach', label: 'Engagement rate (reach)', section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business','linkedin','tiktok'], format: 'percent', source: 'derived.engagement_rate_reach', available: false, deprecated: true,
    scope: 'content',
    description: 'Engagements divided by reach instead of impressions. Deprecated Facebook metric.' },
  { key: 'engaged_users_daily', label: 'Engaged users (daily)', section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business'],        format: 'number',   source: 'derived.engaged_users_daily',   available: false, deprecated: true,
    scope: 'channel',
    description: 'Daily unique users who took any action on your content. Deprecated Facebook metric.' },
  { key: 'link_clicks',         label: 'Link clicks',         section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.link_clicks',           available: false, deprecated: true,
    scope: 'content',
    description: 'Clicks on links inside posts. Deprecated Facebook metric.' },
  { key: 'photo_clicks',        label: 'Photo clicks',        section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.photo_clicks',          available: false, deprecated: true,
    scope: 'content',
    description: 'Clicks on photos inside posts. Deprecated Facebook metric.' },
  { key: 'video_plays',         label: 'Video plays',         section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.video_plays',           available: false, deprecated: true,
    scope: 'content',
    description: 'Times videos in posts started playing. Deprecated Facebook metric — use Video views.' },
  { key: 'profile_cta_clicks',  label: 'Profile CTA clicks',  section: 'engagements', category: 'channel', platforms: ['facebook_page','instagram_business'],          format: 'number',   source: 'derived.profile_cta_clicks',    available: false,
    scope: 'channel',
    description: 'Clicks on the call-to-action button on your profile (Call, Email, Directions, etc.). Requires page_total_actions ingestion.' },
  { key: 'other_clicks',        label: 'Other clicks',        section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.other_clicks',          available: false, deprecated: true,
    scope: 'content',
    description: 'Clicks on parts of a post that are not links, photos or videos. Deprecated Facebook metric.' },
  { key: 'clicks',              label: 'Clicks',              section: 'engagements', category: 'channel', platforms: ['facebook_page','linkedin'],                    format: 'number',   source: 'post_analytics.clicks',         available: true, deprecated: true,
    scope: 'content',
    description: 'The total number of clicks on links, photos and other content within your posts. Facebook deprecated the legacy post_clicks metric.' },
  ...
  { key: 'negative_actions',    label: 'Negative actions',    section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.negative_actions',      available: false, deprecated: true,
    scope: 'channel',
    description: 'Hides, hides-of-all, reports and unlikes attributed to your content. Deprecated Facebook metric.' },
  { key: 'negative_fans',       label: 'Negative fans',       section: 'engagements', category: 'channel', platforms: ['facebook_page'],                               format: 'number',   source: 'derived.negative_fans',         available: false, deprecated: true,
    scope: 'channel',
    description: 'People who unfollowed/unliked the Page during the period. Deprecated Facebook metric.' },
