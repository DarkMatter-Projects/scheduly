...
router.post('/google/rediscover-all', authenticate, requireRole('admin', 'manager'), adsController.rediscoverAllGoogle);
...
router.post('/tiktok/rediscover-all', authenticate, requireRole('admin', 'manager'), adsController.rediscoverAllTikTok);
