...
export const DASHBOARD_TEMPLATES = [
  {
    ...
    available: true,
    description: 'Followers, reactions, reach and engagement on your Facebook Pages.',
    widgets: [
      { category: 'channel', widgetType: 'key_metrics', title: 'Page key metrics', metricKeys: ['followers','impressions','reach','engagement_rate'], width: 12, height: 2 },
  ...
  },
  {
    ...
    available: true,
    description: 'Followers, reach, saves, story stats — all your IG accounts.',
    widgets: [
      { category: 'channel', widgetType: 'key_metrics', title: 'Account key metrics', metricKeys: ['followers','reach','impressions','engagement_rate'], width: 12, height: 2 },
  ...
  },
  {
    ...
    available: true,
    badge: 'Updated',
    description: 'Video views, likes, shares — both organic and ads.',
    widgets: [
      { category: 'channel', widgetType: 'key_metrics', title: 'TikTok key metrics', metricKeys: ['video_views','likes','comments','shares'], width: 12, height: 2 },
      { category: 'channel', widgetType: 'time_series', title: 'Video views', metricKeys: ['video_views'], width: 6, height: 3 },
  ...
  },
  {
    ...
    available: true,
    badge: 'Updated',
    description: 'Incoming comments and DMs, response time, sentiment.',
    widgets: [
      { category: 'engage', widgetType: 'key_metrics', title: 'Inbox volume', metricKeys: ['incoming_messages','response_rate','avg_response_time','negative_sentiment_rate'], width: 12, height: 2 },
      { category: 'engage', widgetType: 'time_series', title: 'Incoming volume over time', metricKeys: ['incoming_messages'], width: 12, height: 3 },
    ],
  },
  {
    key: 'fans_overview',
