-- Dedicated Scheduly project only. No fixtures, credentials or public API access.
...
REVOKE ALL ON SCHEMA scheduly FROM anon, authenticated;
REVOKE ALL ON ALL TABLES IN SCHEMA scheduly FROM anon, authenticated;
REVOKE ALL ON ALL SEQUENCES IN SCHEMA scheduly FROM PUBLIC, anon, authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA scheduly REVOKE ALL ON TABLES FROM PUBLIC, anon, authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA scheduly REVOKE ALL ON SEQUENCES FROM PUBLIC, anon, authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA scheduly REVOKE EXECUTE ON FUNCTIONS FROM PUBLIC, anon, authenticated;
